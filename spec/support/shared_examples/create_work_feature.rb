RSpec.shared_examples "create work feature spec" do |work_class|
  context 'a logged in user', clean: true do
    ...
    scenario do
      ...
      choose "payload_concern", option: work_class
      VCR.use_cassette('iucat_libraries_up') do
        click_button "Create work"
      end

      expect(page).to have_content "Add New #{work_class.underscore.titleize}"
      ...
      # its element
      find('body').click
      choose("#{work_class.underscore}_visibility_open")
